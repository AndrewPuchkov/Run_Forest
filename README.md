...
Выдаст ошибку скорее всего в начале по типу - нет данных для обучения. Вставить для этого свой путь к обучаемой папке. Данные для обучения подгружу днём в Яндекс Мессенджере.  
