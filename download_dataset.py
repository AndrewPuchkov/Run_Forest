...
def setup_argparse():
    ...
    parser.add_argument(
        "--output_dir", default="D:/run_forest/data/spatial-reasoning", help="Output directory"
    )
    parser.add_argument(
        "--start_idx", default=20535, type=int, required=False, help="Start index for windows"
    )
    parser.add_argument(
